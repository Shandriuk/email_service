...
from .views import emails, mailing_list, mailing, templates, activate_mailing, open_tracking, emails_edit
...
urlpatterns = [
    ...
    path('activate-mailing/', activate_mailing, name='active_mailing'),
